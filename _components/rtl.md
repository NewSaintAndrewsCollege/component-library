---
component: Right-to-left support
---
...
If you [setup UIkit from Github source](installation.html#compile-from-github-source), you can also compile the RTL version of UIkit yourself. This will include any [custom UIkit theme](less.html) you have created in the `custom/` directory.
