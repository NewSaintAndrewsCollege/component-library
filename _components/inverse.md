...
**Note** Some modifiers from the [Section](section.html), [Card](card.html), [Tile](tile.html), [Overlay](overlay.html) and [Off-canvas](offcanvas.html) component are extending the inverse style automatically, so you don't have to add any class.
