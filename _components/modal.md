...
<div id="modal-full" class="uk-modal-full" uk-modal>
    <div class="uk-modal-dialog">
        ...
        <div class="uk-grid-collapse uk-child-width-1-2@s uk-flex-middle" uk-grid>
            <div class="uk-background-cover" style="background-image: url(16&quot;/component-library/images/photo.jpg16&quot;);" uk-height-viewport></div>
...
<div id="modal-media-video" class="uk-flex-top" uk-modal>
    <div class="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
        <button class="uk-modal-close-outside" type="button" uk-close></button>
        <video src="https://yootheme.com/site//component-library/images/media/yootheme-pro.mp4" controls playsinline uk-video></video>
    </div>
</div>
...
<p uk-margin>
    ...
    <script>
       ...
       UIkit.util.on(16&quot;#js-modal-dialog16&quot;, 16&quot;click16&quot;, function (e) {
           e.preventDefault();
           e.target.blur();
           UIkit.modal.dialog(16&quot;<p class="uk-modal-body">UIkit dialog!</p>16&quot;);
       });

       UIkit.util.on(16&quot;#js-modal-alert16&quot;, 16&quot;click16&quot;, function (e) {
           e.preventDefault();
           e.target.blur();
           UIkit.modal.alert(16&quot;UIkit alert!16&quot;).then(function () {
               console.log(16&quot;Alert closed.16&quot;)
           });
       });

       UIkit.util.on(16&quot;#js-modal-confirm16&quot;, 16&quot;click16&quot;, function (e) {
           e.preventDefault();
           e.target.blur();
           UIkit.modal.confirm(16&quot;UIkit confirm!16&quot;).then(function () {
               console.log(16&quot;Confirmed.16&quot;)
           }, function () {
               console.log(16&quot;Rejected.16&quot;)
           });
       });

       UIkit.util.on(16&quot;#js-modal-prompt16&quot;, 16&quot;click16&quot;, function (e) {
           e.preventDefault();
           e.target.blur();
           UIkit.modal.prompt(16&quot;Name:16&quot;, 16&quot;Your name16&quot;).then(function (name) {
               console.log(16&quot;Prompted:16&quot;, name)
           });
       });
