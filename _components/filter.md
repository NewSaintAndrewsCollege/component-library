...
<div uk-filter="target: .js-filter">
    ...
    <ul class="uk-subnav uk-subnav-pill">
        <li class="uk-active" uk-filter-control="[data-color=16&quot;white16&quot;]"><a href="#">White</a></li>
        <li uk-filter-control="[data-color=16&quot;blue16&quot;]"><a href="#">Blue</a></li>
        <li uk-filter-control="[data-color=16&quot;black16&quot;]"><a href="#">Black</a></li>
    </ul>
...
<div uk-filter="target: .js-filter">
    ...
    <ul class="uk-subnav uk-subnav-pill">
        ...
        <li uk-filter-control="[data-color=16&quot;white16&quot;]"><a href="#">White</a></li>
        <li uk-filter-control="[data-color=16&quot;blue16&quot;]"><a href="#">Blue</a></li>
        <li uk-filter-control="[data-color=16&quot;black16&quot;]"><a href="#">Black</a></li>
    </ul>
...
<div uk-filter="target: .js-filter">
    ...
    <ul class="uk-subnav uk-subnav-pill">
        <li uk-filter-control="[data-tags*=16&quot;white16&quot;]"><a href="#">White</a></li>
        <li uk-filter-control="[data-tags*=16&quot;blue16&quot;]"><a href="#">Blue</a></li>
        <li uk-filter-control="[data-tags*=16&quot;black16&quot;]"><a href="#">Black</a></li>
        <li uk-filter-control="[data-tags*=16&quot;dark16&quot;]"><a href="#">Dark Colors</a></li>
    </ul>
...
<div uk-filter="target: .js-filter">
    ...
    <div class="uk-grid-small uk-grid-divider uk-child-width-auto" uk-grid>
        ...
        <div>
            <ul class="uk-subnav uk-subnav-pill" uk-margin>
                <li uk-filter-control="[data-size=16&quot;small16&quot;]"><a href="#">Small</a></li>
                <li uk-filter-control="[data-size=16&quot;medium16&quot;]"><a href="#">Medium</a></li>
                <li uk-filter-control="[data-size=16&quot;large16&quot;]"><a href="#">Large</a></li>
            </ul>
        </div>
    </div>
...
<div uk-filter="target: .js-filter">
    ...
    <div class="uk-grid-small uk-grid-divider uk-child-width-auto" uk-grid>
        ...
        <div>
            <ul class="uk-subnav uk-subnav-pill" uk-margin>
                <li uk-filter-control="filter: [data-color=16&quot;white16&quot;]; group: data-color"><a href="#">White</a></li>
                <li uk-filter-control="filter: [data-color=16&quot;blue16&quot;]; group: data-color"><a href="#">Blue</a></li>
                <li uk-filter-control="filter: [data-color=16&quot;black16&quot;]; group: data-color"><a href="#">Black</a></li>
            </ul>
        </div>
        <div>
            <ul class="uk-subnav uk-subnav-pill" uk-margin>
                <li uk-filter-control="filter: [data-size=16&quot;small16&quot;]; group: size"><a href="#">Small</a></li>
                <li uk-filter-control="filter: [data-size=16&quot;medium16&quot;]; group: size"><a href="#">Medium</a></li>
                <li uk-filter-control="filter: [data-size=16&quot;large16&quot;]; group: size"><a href="#">Large</a></li>
            </ul>
        </div>
    </div>
