    ...
    <div class="js-wrapper">
        ...
        <div uk-overflow-auto="selContainer: .uk-height-medium; selContent: .js-wrapper">
            <div class="uk-grid-small" uk-grid>
                <div class="uk-width-1-2"><img src="/component-library/images/light.jpg" alt=""></div>
                <div class="uk-width-1-2"><img src="/component-library/images/dark.jpg" alt=""></div>
                <div class="uk-width-1-2"><img src="/component-library/images/photo.jpg" alt=""></div>
                <div class="uk-width-1-2"><img src="/component-library/images/photo2.jpg" alt=""></div>
            </div>
        </div>
...
{% include example.html content='
<div class="uk-inline">
    <img src="/component-library/images/photo.jpg" width="300" alt="">
...
{% include example.html content='
<img class="uk-border-rounded" src="/component-library/images/avatar.jpg" width="200" height="200" alt="Border rounded">
<img class="uk-border-circle" src="/component-library/images/avatar.jpg" width="200" height="200" alt="Border circle">
<img class="uk-border-pill" src="/component-library/images/avatar.jpg" width="200" height="200" alt="Border pill">
' %}
...
<div class="uk-child-width-expand@s" uk-grid>
    <div>
        <div class="uk-panel uk-padding uk-background-muted">
            <a class="uk-logo" href="#">
                <img src="/component-library/images/logo-placeholder.svg" alt="">
                <img class="uk-logo-inverse" src="/component-library/images/logo-placeholder-light.svg" alt="">
            </a>
        </div>
    </div>
    <div>
...
<div class="uk-child-width-1-2 uk-child-width-1-3@s uk-grid-small uk-light" uk-grid>
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-multiply" src="/component-library/images/dark.jpg" alt="Blend Multiply">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-screen" src="/component-library/images/dark.jpg" alt="Blend Screen">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-overlay" src="/component-library/images/dark.jpg" alt="Blend Overlay">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-darken" src="/component-library/images/dark.jpg" alt="Blend Darken">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-lighten" src="/component-library/images/dark.jpg" alt="Blend Lighten">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-color-dodge" src="/component-library/images/dark.jpg" alt="Blend Color Dodge">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-color-burn" src="/component-library/images/dark.jpg" alt="Blend Color Burn">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-hard-light" src="/component-library/images/dark.jpg" alt="Blend Hard Light">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-soft-light" src="/component-library/images/dark.jpg" alt="Blend Soft Light">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-difference" src="/component-library/images/dark.jpg" alt="Blend Difference">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-exclusion" src="/component-library/images/dark.jpg" alt="Blend Exclusion">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-hue" src="/component-library/images/dark.jpg" alt="Blend Hue">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-saturation" src="/component-library/images/dark.jpg" alt="Blend Saturation">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-color" src="/component-library/images/dark.jpg" alt="Blend Color">
            <div class="uk-position-center">
    ...
    <div>
        <div class="uk-inline uk-background-primary">
            <img class="uk-blend-luminosity" src="/component-library/images/dark.jpg" alt="Blend Luminosity">
            <div class="uk-position-center">
