...
This component is mostly used in combination with the [Overlay component](overlay.html) as elements are transitioned from invisible to visible state. To place the overlay on top of another element, like an image, use the [Position component](position.html).
...
<div class="uk-child-width-1-2 uk-child-width-1-3@s uk-grid-match uk-grid-small" uk-grid>
    ...
    <div class="uk-text-center">
        <div class="uk-inline-clip uk-transition-toggle" tabindex="0">
            <img src="/component-library/images/dark.jpg" alt="">
            <img class="uk-transition-scale-up uk-position-cover" src="/component-library/images/light.jpg" alt="">
        </div>
        <p class="uk-margin-small-top">2 Images</p>
    </div>
    <div class="uk-text-center">
        <div class="uk-inline-clip uk-transition-toggle" tabindex="0">
            <img class="uk-transition-scale-up uk-transition-opaque" src="/component-library/images/dark.jpg" alt="">
        </div>
