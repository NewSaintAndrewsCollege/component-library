...
<script>
    ...
    UIkit.upload(16&quot;.js-upload16&quot;, {

        url: 16&quot;16&quot;,
        multiple: true,

        beforeSend: function () {
            console.log(16&quot;beforeSend16&quot;, arguments);
        },
        beforeAll: function () {
            console.log(16&quot;beforeAll16&quot;, arguments);
        },
        load: function () {
            console.log(16&quot;load16&quot;, arguments);
        },
        error: function () {
            console.log(16&quot;error16&quot;, arguments);
        },
        complete: function () {
            console.log(16&quot;complete16&quot;, arguments);
        },

        loadStart: function (e) {
            console.log(16&quot;loadStart16&quot;, arguments);

            bar.removeAttribute(16&quot;hidden16&quot;);
            bar.max = e.total;
            bar.value = e.loaded;
        },

        progress: function (e) {
            console.log(16&quot;progress16&quot;, arguments);
        ...
        loadEnd: function (e) {
            console.log(16&quot;loadEnd16&quot;, arguments);
        ...
        completeAll: function () {
            console.log(16&quot;completeAll16&quot;, arguments);

            setTimeout(function () {
                bar.setAttribute(16&quot;hidden16&quot;, 16&quot;hidden16&quot;);
            }, 1000);

            alert(16&quot;Upload Completed16&quot;);
        }
